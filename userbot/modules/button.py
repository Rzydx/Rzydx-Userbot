...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}button test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/RzydxProject:same> [Support]<buttonurl:https://t.me/margamodedisini>`\
    "
    }
)
