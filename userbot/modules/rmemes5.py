...
async def _(event):
    rr = await edit_or_reply(event, "SAYANGGGGGGGGG 💕")
    sleep(1)
    await rr.edit("💝💘💓💗")
    sleep(1)
    await rr.edit("💞💕💗💘")
    ...
    await rr.edit("💘💞💕💗")
    sleep(1)
    await rr.edit("EMMMMMM🥺🥺🥺")
    sleep(1)
    await rr.edit("💝💘💓💗")
    await rr.edit("💞💕💗💘")
    await rr.edit("💘💞💕💗")
    await rr.edit("SAYANG")
    sleep(1)
    await rr.edit("AKU 👉👈")
    sleep(1)
    await rr.edit("SANGE 👉👈 😘😘")
    ...
    await rr.edit("SAYANG")
    sleep(1)
    await rr.edit("AYO NGEWE🤭🤭")
    sleep(1)
    await rr.edit("PLISS🥺🥺")
    sleep(1)
    await rr.edit("AKU SANGE😋😋")
    sleep(1)
    await rr.edit("I LOVE YOUUUU")
    sleep(1)
    await rr.edit("AH AH AH BEIBB")
    sleep(1)
    await rr.edit("💦💦💦💦")
    sleep(1)
    await rr.edit("OH BABY")
    sleep(1)
    await rr.edit("AKU SAYANG KAMU💞")


@ram_cmd(pattern="orgil(?: |$)(.*)")
async def _(event):
    typew = await edit_or_reply(event, "`ANJING ADA ORANG GILA.....`")
    sleep(1)
...
@ram_cmd(pattern="gabut$")
async def _(event):
    e = await edit_or_reply(event, "`Kawan kawan Aku mau cerita sedikit`")
    sleep(1)
